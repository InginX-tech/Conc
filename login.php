...
<head>
    ...
    <meta name="description"
        content="Flamingo admin is super flexible, powerful, clean &amp; modern responsive bootstrap 4 admin template with unlimited possibilities.">
    <meta name="keywords"
        content="admin, Flamingo admin, dashboard, flat admin, responsive admin , web app">
    <meta name="author" content="pixelstrap">
    <link rel="icon" href="assets/images/dashboard/favicon.png" type="image/x-icon">
    <link rel="shortcut icon" href="assets/images/dashboard/favicon.png" type="image/x-icon">
    <title>Flamingo - Premium Admin</title>
...
<body>
                    ...
                    <div class="col-md-5 p-0 card-left">
                        <div class="card bg-primary">
                            ...
                            <div class="single-item">
                                <div>
                                    <div>
                                        <h3>Welcome to Flamingo</h3>
                                        <p>
                                            High quality & consistent concrete
                                            Serving the best in the industry to ensure that you get the value for your money!
                                        </p>
                                    </div>
                                </div>
                                <div>
                                ...
                                <div class="tab-content" id="top-tabContent">
                                        ...
                                        <form class="form-horizontal auth-form">
                                            <div class="form-group">
                                                <input required="" name="phonenumber" type="text"
                                                    class="form-control" placeholder="phone" id="phonenumber">
                                            </div>
                                            <div class="form-group">
                                                <input required="" id="login_password" name="login_password" type="password"
                                    ...
                                    <div class="tab-pane fade" id="top-contact" role="tabpanel"
                                        ...
                                        <form class="form-horizontal auth-form">
                                            ...
                                            <div class="form-group">
                                                <input required="" id="confirmpass" name="confirmpass" type="password"
                                            ...
                                            <div class="form-button">
                                                <button class="btn btn-primary register_btn" type="submit">Register</button>
                                            </div>
                                            <div class="form-footer">
                                                <span>Our social platforms</span>
                                                <ul class="social">
    ...
    <?php include 'scripts/auth/auth_scripts.php'; ?>
